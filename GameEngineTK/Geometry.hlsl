...
//バーテックスシェーダー
//4
VS_OUTPUT VS(float4 Pos : POSITION , float4 Normal:NORMAL,float2 _Tex: TEXCOORD)
{
...
float4 PS(VS_OUTPUT input) : SV_Target
{
	...
	return (g_Diffuse * NL + Specular*g_Specular) / 2 + g_texColor.Sample(g_samLinear, input.Tex);
