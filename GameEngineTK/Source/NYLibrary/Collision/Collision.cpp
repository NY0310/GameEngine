...
// 3点から三角形を構築
void NYLibrary::ComputeTriangle(const Vector3& _p0, const Vector3& _p1, const Vector3& _p2, Triangle* _Triangle)
{
	//座標をコピー
	_Triangle->P0 = _p0;
	_Triangle->P1 = _p1;
...
// メ　モ : 
//--------------------------------------------------------------------------------------------
void NYLibrary::ClosestPtPoint2Triangle(const Vector3& _point, const Triangle& _triangle, Vector3* _closest)
{
...
// 三角形と点の当たり判定
bool NYLibrary::CheckPoint2Triangle(const Vector3& _point, const Triangle& _triangle)
{
...
// メ　モ : 裏面の当たりはとらない
//--------------------------------------------------------------------------------------------
bool NYLibrary::CheckSphere2Triangle(const Sphere& _sphere, const Triangle& _triangle, Vector3 *_inter)
{
	Vector3 p;
...
// メ　モ : 裏面の当たりはとらない
//--------------------------------------------------------------------------------------------
bool NYLibrary::CheckSegment2Triangle(const Segment& _segment, const Triangle& _triangle, Vector3 *_inter)
{
