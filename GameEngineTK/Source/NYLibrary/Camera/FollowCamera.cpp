...
void FollowCamera::Update()
{
	...
	//追従対象の座標等をセット
	SetTarGetTrans(player->GetPosition());
	SetTargetAngle(player->GetRotationY());
	...
	//this->SetEyePos(D3DXVECTOR3(0.0f, 0.0f, -2.0f)); //視点位置
	//this->SetRefPos(D3DXVECTOR3(-0.0f, 0.5f, 0.0f));//注視位置
	//this->SetUpVec(D3DXVECTOR3(0.0f, 1.0f, 0.0f));//上方位置
	//m_fovY = XM_PI / 4;
